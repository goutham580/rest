...
public class Product {
	...
	private static void updatePrices() {
		EntityManagerFactory emf = (EntityManagerFactory)EzcEntityFactory.createEntityManager();
	...
	private ProductText getProductText(EntityManager em) {
		TypedQuery<ProductText> query = (TypedQuery<ProductText>) em.createQuery("SELECT p FROM ProductText p WHERE p.productId = :productId AND p.language = :language");
		try {
